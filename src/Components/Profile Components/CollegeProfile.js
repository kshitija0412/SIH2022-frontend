		...
		<MantineProvider
			...
			>
				...
				<Stepper.Step label="Course Details" allowStepSelect={active > 3}>
					<div>
						<h2 style= {{fontSize: "1.5rem", marginTop: "1rem"}}>Course Details</h2>
					</div>
<Box
				sx={(theme) => ({
					backgroundColor:
			...
			>
				...
				<Stepper.Step label="Department Details" allowStepSelect={active > 4}>
					<div>
						<h2 style= {{fontSize: "1.5rem", marginTop: "1rem"}}>Department Details</h2>
					</div>
					<Box
				sx={(theme) => ({
					backgroundColor:
			...
			<div className="flex-container">
				...
				{ active < 6 ? <div> <Button variant="filled" color="dark-teal" onClick={nextStep}> Next step
					</Button> </div> : <br /> }
			</div>
			</MantineProvider>
		</>
