    ...
    facultyextc: [
      {
        ...
        qualification: "Post-doc - Optical communications",
        age: 36,
      },
      {
              ...
              <Table size="small" aria-label="Department Details">
                ...
                <TableBody>
                  {row.facultyextc.map((facultyextcRow) => (
                    <TableRow key={facultyextcRow.name}>
                      <TableCell component="th" scope="row">
                        {facultyextcRow.name}
                      </TableCell>
...
export default function CollapsibleTable() {
  return (
    <>
      <h2 style={{textAlign: "center", color: '#0A57A4'}}>Department Details</h2>
        ...
        <Table aria-label="collapsible table">
          <TableHead>
            <TableRow>
              ...
              <TableCell><b>Student Intake</b></TableCell>
              <TableCell><b>Teaching Faculty</b></TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {rows.map((row) => (
